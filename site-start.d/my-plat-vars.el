...
(defconst is-before-emacs-21 (>= 21 emacs-major-version) "Is before emacs 21")
(defconst is-after-emacs-23  (<= 23 emacs-major-version) "Is after emacs 23")

(provide 'my-plat-vars)
